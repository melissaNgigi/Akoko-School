...
document.getElementById('boardMemberForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const response = await fetch('https://akoko-backend.onrender.com/admin/update-board-member', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function loadCurrentHODs() {
    try {
        const response = await fetch('https://akoko-backend.onrender.com/admin/staff');
        const data = await response.json();
...
document.getElementById('hodForm').addEventListener('submit', async function (e) {
    ...
    try {
        const response = await fetch('https://akoko-backend.onrender.com/admin/update-hod', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
